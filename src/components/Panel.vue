<template>
    <div class="panel">
        <div class="panel-left">
            <img v-if="userAvatar" :src="userAvatar" width="117" height="117" alt="User profile picture" class="avatar">
            <img v-else src="../assets/default.png" width="117" height="117" alt="User profile picture" class="avatar">
        </div>
        <div class="panel-right">
            ...
            <div class="panel-subheader">
                <a :href="userHtmlUrl" target="_blank">@{{ userLogin }}</a>
            </div>
...
const userLogin = computed(() => {
    return props.data.login ?? 'octocat';
});

const userHtmlUrl = computed(() => {
    return props.data.html_url ?? '#';
});

const userRepos = computed(() => {
    return props.data.public_repos ?? '0';
});
const userFollowers = computed(() => {
    return props.data.followers ?? '0';
});
const userFollowing = computed(() => {
    return props.data.following ?? '0';
});
</script>